...
Dispersement is how much your data is spread out around the **mean** (Example - Are all of your test scores close to the average test score?).

The bell curve is a tool commonly used to help understand standard deviation.

![Bell Curve](https://miro.medium.com/max/875/1*D8TtN3vqbisZUsqRxBJ0Qw.png)
