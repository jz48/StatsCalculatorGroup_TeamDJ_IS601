...
A Z-Score indicates the distance from the mean a data point is.

It can be considered how many standard deviations above or below the population mean a raw score is.
